...
parser.add_argument(
    ...
    dest="name",
    required=True,
    help="Name of your project and repository",
)
parser.add_argument(
    "--private",
    "-p",
    dest="is_private",
    action="store_true",
    help="leave flag off for public or put flag on for private repository",
)
parser.add_argument(
    "--lan",
    type=str,
...
parser.add_argument(
    ...
    dest="new_base",
    action="store_true",
    help="use this flag to indicate you want to create a new base folder for your future web projects",
)
...
try:
    ...
    with open(os.path.join(this, "config.json")) as file:
        ...
        languages = {"py": Python, "web": Web, "php": PHP}
